...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Alert.ward_mapit_id'
        db.add_column('alerts_alert', 'ward_mapit_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Changing field 'Alert.postcode'
        db.alter_column('alerts_alert', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Alert.ward_mapit_id'
        db.delete_column('alerts_alert', 'ward_mapit_id')

        # Changing field 'Alert.postcode'
        db.alter_column('alerts_alert', 'postcode', self.gf('django.db.models.fields.CharField')(max_length=8))
